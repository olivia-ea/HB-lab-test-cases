...
class PartyTests(unittest.TestCase):
    ...
    def test_no_rsvp_yet(self):
        ...
        self.assertIn(b"I'm having an after", results.data)
        self.assertNotIn(b"123 Magic Unicorn Way", results.data)
        print("test ran")
...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def test_games(self):
        ...
        self.assertIn(b"Games", results.data)
        print("games test ran")
